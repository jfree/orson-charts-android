...
public class SurfaceRenderer extends AbstractXYZRenderer implements XYZRenderer,
     ...
     * {@link #composeAll(com.orsoncharts.android.plot.XYZPlot, 
     * com.orsoncharts.android.graphics3d.World, com.orsoncharts.android.graphics3d.Dimension3D,
     ...
     * to draw).  If the face outlines are not drawn, the graphics system can 
     * leave small gaps that you can "see" through (if you don't mind this, 
    ...
    public void composeAll(XYZPlot plot, World world, Dimension3D dimensions, 
        ...
        for (int xIndex = 0; xIndex < this.xSamples; xIndex++) {
            ...
            for (int zIndex = 0; zIndex < this.zSamples; zIndex++) {
                ...
                int color = this.colorScale.valueToColor(ymm);
