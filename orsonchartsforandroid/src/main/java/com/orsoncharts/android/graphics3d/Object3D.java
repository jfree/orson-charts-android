...
public class Object3D {
    ...
    public static Object3D createYSheet(double size, double x, double y, 
            double z, int color, boolean invert) {
    ...
    public static Object3D createCube(double size, double xOffset, 
            double yOffset, double zOffset, int color) {
    ...
    public static Object3D createSphere(double radius, int n,
            double x, double y, double z, int extColor, int intColor) {
     ...
     *     <code>-1</code>, the <code>color</code> is used instead).
    ...
    public static Object3D createBar(double xWidth, double zWidth, double x, 
            double y, double z, double zero, int barColor, int baseColor,
            int topColor, boolean inverted) {
